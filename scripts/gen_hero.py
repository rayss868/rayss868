...
Port of the browser renderer at rayss868.com/js/ascii3d.js so the README and the
...
def main():
    ...
    wordmark = read_art("rayss868.txt")

    write("hero-dark.svg", build_spinner(model, DARK_PURPLE, "rayss868 logo, rotating"))
    write("hero-light.svg", build_spinner(model, LIGHT_PURPLE, "rayss868 logo, rotating"))
    write("wordmark-dark.svg", build_wordmark(wordmark, DARK_PURPLE, "RAYSS868"))
    write("wordmark-light.svg", build_wordmark(wordmark, LIGHT_PURPLE, "RAYSS868"))
